...
tpm='/panfs/accrepfs.vampire/data/booth_lab/LabCode/typical_data_analysis/templates_cerebroMatic/ELP_ses_7/mw_com_prior_Age_0096.nii'; %This is your template path
addpath(genpath(spm_path));
root='/panfs/accrepfs.vampire/data/booth_lab/AM/ELP_autism/'; %This is your project folder
%subjects=('sub-5154'); %manually put subject numbers say 'sub-5004' 'sub-5009', or leave this empty if you have an excel with data_info.
...
CCN.preprocessed_folder='data'; %This is your data folder needs to be preprocessed
CCN.func_folder='sub*Phon*'; % This is your functional folder name
