...
path='/panfs/accrepfs.vampire/data/booth_lab/AM/ELP_autism/';
data_folder='/panfs/accrepfs.vampire/data/booth_lab/AM/ELP_autism/data';
session ='ses-7';
good_subjects=[];
M=readtable([path '/' filenm],'Sheet','GoodRuns');
