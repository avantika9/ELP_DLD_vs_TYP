...
% addpath to script
addpath(genpath('/panfs/accrepfs.vampire/data/booth_lab/AM/ELP_autism/1copy_your_data'));

% Filepath  to subject list file - excel file
Subject_filepath = '/panfs/accrepfs.vampire/data/booth_lab/AM/ELP_autism/Subjects.xlsx';
% Read Subject excel  sheet with multiple T1s for ses 7 or ses9
M=readtable(Subject_filepath, 'sheet', 'T1ses7_multiple'); % Change 

% Path to preprocessed folder where data exists
data_path='/panfs/accrepfs.vampire/data/booth_lab/AM/ELP_autism/data';
% Specify Sesssion
