...
%Jin Wang 3/19/2019
addpath(genpath('/panfs/accrepfs.vampire/data/booth_lab/AM/ELP_autism/scripts/4secondlevel')); %This is the code path
spm_path='/panfs/accrepfs.vampire/data/booth_lab/LabCode/typical_data_analysis/spm12_elp'; %This is your spm path
addpath(genpath(spm_path));

%define your data path
data=struct();
root='/panfs/accrepfs.vampire/data/booth_lab/AM/ELP_autism/data';  %your project path
%  subjects={   'sub-5501', 'sub-5495', 'sub-5480', 'sub-5310', ...
...
%     }; % your subjects
subjects = {};
data_info='/panfs/accrepfs.vampire/data/booth_lab/AM/ELP_autism/Subjects_soundtask.xlsx'; %your subject list excel, if you have regressors, it's better there too.
if isempty(subjects)
...
out_dir='/panfs/accrepfs.vampire/data/booth_lab/AM/ELP_autism/second_level_one_sample_ttest'; % your output folder of secondlevel analysis results
...
analysis_folder='ses7_analysis_phon';
...
if cov==1
    name=[];
    name{1}= 'CTOPP_2_EL_ScS' %'CELF_WC_ScS'; % This should be your column header in your excel, should be exactly to be the same as in your excel, otherwise it won't read in these covariates.
