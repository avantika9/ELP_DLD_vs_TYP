...
ROIdir = '/panfs/accrepfs.vampire/data/booth_lab/AM/ELP_autism/second_level_two_sample_ttest';
roi_file_root = [ROIdir '/phon_new'];
...
% set parameters
namerois = {'DLD_vs_TYP_lIFGop' 'DLD_vs_TYP_pSTG_SMG' 'DLD_vs_TYP_lCaudate'}; %put the name of the roi files here, omitting the '_rot.mat' part
...
data_info='/panfs/accrepfs.vampire/data/booth_lab/AM/ELP_autism/Subjects_soundtask.xlsx';
