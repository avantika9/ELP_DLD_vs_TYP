...
ROIdir = '/panfs/accrepfs.vampire/data/booth_lab/AM/ELP_autism/scripts/';
roi_file_root = [ROIdir 'ROI'];
...
%addpath(pwd);
addpath ('/panfs/accrepfs.vampire/data/booth_lab/AM/ELP_autism/scripts/GetBetas');
% set parameters
namerois = {'l_IFGtri' 'ROI_pMTG_AG_union'}; %put the name of the roi files here, omitting the '_rot.mat' part
...
data_info='/panfs/accrepfs.vampire/data/booth_lab/AM/ELP_autism/Subjects_meaningtask.xlsx';
...
%subject)
nameconditions={'Sn(1) S_C'  'Sn(1) S_H'  'Sn(1) S_L'  'Sn(1) S_U'  ...
                'Sn(2) S_C'  'Sn(2) S_H'  'Sn(2) S_L'  'Sn(2) S_U'};
                
           

%These entries correspond to the condition names in nameconditions. I'd like to use these for column headings.
friendlyconditions=	{'R1S_C' 'R1S_H' 'R1S_L' 'R1S_U' ...
